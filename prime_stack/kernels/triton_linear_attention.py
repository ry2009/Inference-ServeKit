...
else:  # pragma: no cover - fallback when Triton unavailable
    def _kernel(*args, **kwargs):  # type: ignore[return-value]
        raise RuntimeError("Triton is not available; install triton to use triton_linear_attention")
